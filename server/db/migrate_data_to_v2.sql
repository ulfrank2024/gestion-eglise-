-- Fichier: server/db/migrate_data_to_v2.sql
-- Script de migration des données de v1 vers v2
...
-- Mettre à jour updated_at pour les nouvelles entrées
